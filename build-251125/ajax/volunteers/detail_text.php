...
$arSelect = ['ID', 'NAME', 'PREVIEW_TEXT', 'DETAIL_TEXT',  'PREVIEW_PICTURE', 'DETAIL_PICTURE', 'PROPERTY_WHERE', 'PROPERTY_TIME', 'PROPERTY_ADDRESS']; // Настройте под свои поля
...
<div id="slide-popup" class="map-popup">
        <div class="map-popup__content">
          <div class="map-popup__list">
            <div class="map-popup__event" id="guide-1">
                <div class="map-popup__title"><?=htmlspecialchars($arItem['NAME'])?></div>
                <div class="map-popup__info"><?=htmlspecialchars($arItem['NAME'])?></div>
