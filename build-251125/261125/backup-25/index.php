                ...
                <div class="media media--main">
                  <div class="media__block">
                    ...
                    <div class="media__img-wrapper">
                      <img class="media__img " src="img/business/bukinist.png" width="474" height="424" alt="Бизнес Букинист Смена">
                    </div>
                    <div class="media__txt-wrapper">
                      <h4 class="media__title">Букинист «Смена»</h4>
                      <p class="media__txt">
                        «Смена», который в том числе занимается издательской деятельностью, обращая внимание людей на малоизвестные краеведческие сюжеты, жертвует 10% от оборота 2 декабря Благотворительному фонду «Детям», на проект «Больничные няни» - на дежурства с детьми – сиротами в больницах Казани
                      </p>
                      <p class="media__txt" style="font-weight: bold;">
                        <br>
                        2 декабря, весь день
                      </p>
                      <p class="media__txt" style="font-weight: bold;">ул. Кави Наджми, 3/9</p>
                      <ul>
                        <li class="media__txt">Сайт: <a href="www.детям116.рф" target="_blank">www.детям116.рф</a></li>
                        <li class="media__txt">VK: <a href="https://vk.com/blagodetyam" target="_blank">https://vk.com/blagodetyam</a></li>
                      </ul>
                      <p class="media__txt">Покупая - делаем добро! Щедрым быть просто!</p>
                    </div>
              ...
              <div class="book-carousel__slide-inner">
                <div class="media media--main">
                  <div class="media__block">
                    ...
                    <div class="media__img-wrapper">
                      <img class="media__img " src="img/business/bukinist-2.png" width="474" height="424" alt="Бизнес Букинист Смена">
                    </div>
                    <div class="media__txt-wrapper">
                      <h4 class="media__title">Книжный магазин «Смена»</h4>
                      <p class="media__txt">
                        Магазин «Смена», который представляет книги независимых издательств, не попадающие на полки сетевых магазинов, жертвует 10% от оборота 2 декабря Благотворительному фонду «Детям», напроект «Больничные няни» - на дежурства с детьми – сиротами в больницах Казани
                      </p>
                      <p class="media__txt" style="font-weight: bold;">
                        <br>
                        2 декабря, весь день
                      </p>
                      <p class="media__txt" style="font-weight: bold;">Центр современной культуры «Смена», ул. Бурхана Шахиди 7</p>
                      <p class="media__txt" style="font-weight: bold;">Национальная библиотека РТ, ул. Пушкина 86</p>
                      <ul>
                        <li class="media__txt">Сайт: <a href="www.детям116.рф" target="_blank">www.детям116.рф</a></li>
                        <li class="media__txt">VK: <a href="https://vk.com/blagodetyam" target="_blank">https://vk.com/blagodetyam</a></li>
                      </ul>
              ...
              <div class="book-carousel__slide-inner">
                <div class="media media--main">
                  <div class="media__block">
                    ...
                    <div class="media__img-wrapper">
                      <img class="media__img " src="img/business/shine.png" width="474" height="424" alt="Бизнес Букинист Смена">
                    </div>
                    <div class="media__txt-wrapper">
                      <h4 class="media__title">Магазин пластинок «Сияние»</h4>
                      <p class="media__txt">
                        Магазин, продавая коллекцию пластинок, где более 8 тысяч записей любых музыкальных жанров и направлений, жертвует 10% от оборота 2 декабря Благотворительному фонду «Детям», на проект «Больничные няни» - на дежурства с детьми – сиротами в больницах Казани
                      </p>
                      <p class="media__txt" style="font-weight: bold;">
                        <br>
                        2 декабря, весь день
                      </p>
                      <p class="media__txt" style="font-weight: bold;">Бурхана Шахиди, 7</p>
                      <ul>
                        <li class="media__txt">Сайт: <a href="www.детям116.рф" target="_blank">www.детям116.рф</a></li>
                        <li class="media__txt">VK: <a href="https://vk.com/blagodetyam" target="_blank">https://vk.com/blagodetyam</a></li>
                      </ul>
              ...
              <div class="book-carousel__slide-inner">
                <div class="media media--main">
                  <div class="media__block">
                    ...
                    <div class="media__img-wrapper">
                      <img class="media__img " src="img/business/sisters.png" width="474" height="424" alt="Бизнес Букинист Смена">
                    </div>
                    <div class="media__txt-wrapper">
                      <h4 class="media__title">Студия цветов и декора SISTERS</h4>
                      <p class="media__txt">
                        Студия, в которой можно найти прекрасные букеты, декор, сухоцветы, свечи и многое другое, жертвует 50% от продажи цветов 2 декабря Благотворительному фонду «Детям», на проект «Больничные няни» - на дежурства с детьми – сиротами в больницах Казани
                      </p>
                      <p class="media__txt" style="font-weight: bold;">
                        <br>
                        2 декабря, весь день
                      </p>
                      <p class="media__txt" style="font-weight: bold;">Ул. Муштари, 19</p>
                      <ul>
                        <li class="media__txt">Сайт: <a href="www.детям116.рф" target="_blank">www.детям116.рф</a></li>
                        <li class="media__txt">VK: <a href="https://vk.com/blagodetyam" target="_blank">https://vk.com/blagodetyam</a></li>
                      </ul>
